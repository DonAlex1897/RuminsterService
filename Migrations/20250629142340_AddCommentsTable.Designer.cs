...
namespace RuminsterBackend.Migrations
{
    ...
    [Migration("20250629142340_AddCommentsTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RuminsterBackend.Models.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("CreateById")
                        .HasDatabaseName("ix_comments_create_by_id");

                    b.HasIndex("ParentCommentId")
                        .HasDatabaseName("ix_comments_parent_comment_id");

                    b.HasIndex("RuminationId")
                        .HasDatabaseName("ix_comments_rumination_id");

                    b.HasIndex("UpdateById")
                        .HasDatabaseName("ix_comments_update_by_id");
            ...
            modelBuilder.Entity("RuminsterBackend.Models.Comment", b =>
                {
                    b.HasOne("RuminsterBackend.Models.User", "CreateBy")
                        .WithMany("CommentsCreateBy")
                        .HasForeignKey("CreateById")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_comments_asp_net_users_create_by_id");

                    b.HasOne("RuminsterBackend.Models.Comment", "ParentComment")
                    ...
                    b.HasOne("RuminsterBackend.Models.Rumination", "Rumination")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .HasConstraintName("fk_comments_ruminations_rumination_id");

                    b.HasOne("RuminsterBackend.Models.User", "UpdateBy")
                        .WithMany("CommentsUpdateBy")
                        .HasForeignKey("UpdateById")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_comments_asp_net_users_update_by_id");
            ...
            modelBuilder.Entity("RuminsterBackend.Models.User", b =>
                {
                    b.Navigation("CommentsCreateBy");

                    b.Navigation("CommentsUpdateBy");
